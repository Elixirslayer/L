...
export default function Home() {
    ...
    return (
        <>
            <div className="h-screen w-full justify-center bg-no-repeat bg-cover bg-center flex flex-col items-center p-8" style={{backgroundImage:"url('/images/samurai_bebop.png')"}}>
